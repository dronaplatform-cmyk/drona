                ...
                <div className="flex flex-col gap-6">
                    <div className="grid grid-cols-1 items-stretch gap-x-0 gap-y-4 lg:grid-cols-3 lg:gap-4">
                        ...
                        <Card className="col-span-2 flex items-center justify-center p-6">
                            <div className="flex flex-col gap-4">
                                <q className="font-quote text-xl font-medium italic lg:text-3xl">
                                    Drona edtech is a overall reliable platform
                                    for finding a reliable, high-quality tutor
                                    for my child. The customer service is good,
                                    the tutors are genuine and also locally
                                    available. it is a recommended platform...
                                </q>
                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <Card>
                            <CardContent className="text-foreground/70 font-quote px-6 pt-6 leading-7 italic">
                                <q>
                                    As a tutor, Drona gives me the tools I need
                                    to organize my classes and reach more
                                    students. The platform is intuitive and
                                    professional. More power to the people
                            ...
                            <CardFooter>
                                <div className="flex gap-4 leading-5">
                                    <Avatar className="ring-input size-9 rounded-full ring-1">
                                        <AvatarImage
                                            src="/testimonials/ms_revT2vMND5yBos.png"
                                            alt="Manmeet Singh"
                                        />
                        ...
                        <Card>
                            <CardContent className="text-foreground/70 font-quote px-6 pt-6 leading-7 italic">
                                <q>
                                    I love the interactive learning resources
                                    and how easy it is to connect with my
                                    tutors. It makes studying much more
                                    enjoyable.
                                </q>
                            </CardContent>
                            <CardFooter>
                                <div className="flex gap-4 leading-5">
                                    <Avatar className="ring-input size-9 rounded-full ring-1">
                                        <AvatarImage
                                            src="/testimonials/pr_rev5SvtR7N4yQt.jpeg"
                                            alt="Priyanka Jhadodia"
                                        />
                        ...
                        <Card>
                            <CardContent className="text-foreground/70 font-quote px-6 pt-6 leading-7 italic">
                                <q>
                                    The verified profiles having credible
                                    teachers built our trust. We found an
                                    science tutor for our son within days.
                                    Highly recommended!
                                </q>
                            </CardContent>
                            <CardFooter>
                                <div className="flex gap-4 leading-5">
                                    <Avatar className="ring-input size-9 rounded-full ring-1">
                                        <AvatarImage
                                            src="/testimonials/dhv_revB4fUnSskcfC4JZ.png"
                                            alt="Dhvani Rao"
                                        />
