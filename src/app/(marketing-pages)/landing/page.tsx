        ...
        <>
            <section>
                <div className="flex items-center justify-between gap-8">
                    <div className="z-10 flex w-full flex-col items-center pr-4 pl-4 text-center lg:items-start lg:pl-20 lg:text-left">
                        {badge && (
                        ...
                        <h1 className="font-gloock my-6 text-4xl text-balance lg:text-6xl">
                            {heading}
                        </h1>
                    ...
                    {features.map(tab => {
                        return (
                            <TabsTrigger
                                key={tab.id}
                                value={tab.id}
                                className={`hover:border-muted data-[state=active]:bg-muted group flex w-full flex-col items-start justify-start gap-1 rounded-md border p-4 text-left whitespace-normal shadow-none transition-opacity duration-200 hover:opacity-80 data-[state=active]:shadow-none ${
                                    tab.isDefault ? '' : ''
                                }`}>
    ...
    return (
        <section className="py-16">
            <div className="container mx-auto">
                ...
                <h2 className="font-gloock text-3xl text-balance lg:text-4xl">
                    Empowering Education for Everyone
                </h2>
                <div className="mt-14 grid gap-6 lg:mt-20 lg:grid-cols-3">
                    <div className="bg-accent/30 border-border/40 rounded-lg border p-5 backdrop-blur-lg">
                        <span className="bg-background mb-8 flex size-12 items-center justify-center rounded-full">
                            <IconUsers className="text-primary size-6" />
                        </span>
                        <h3 className="mb-2 text-xl font-medium">
                            Verified Tutors
                        </h3>
                        <p className="text-muted-foreground leading-7">
                            We ensure authenticity with standardized profiles
                            for every tutor. Connect with knowledgeable youth
                            and experienced professionals passionate about
                            teaching.
                        </p>
                    </div>
                    <div className="bg-accent/30 border-border/40 rounded-lg border p-5 backdrop-blur-lg">
                        ...
                        <p className="text-muted-foreground leading-7">
                            Stay updated with daily homework logs and detailed
                            performance reports. Our platform ensures you never
                            miss a beat in your child&apos;s academic journey.
                        </p>
                    </div>
                    <div className="bg-accent/30 border-border/40 rounded-lg border p-5 backdrop-blur-lg">
                        <span className="bg-background mb-8 flex size-12 items-center justify-center rounded-full">
                            <IconShieldCheck className="text-primary size-6" />
                        </span>
                        <h3 className="mb-2 text-xl font-medium">
                            Secure & Reliable
                        </h3>
                        <p className="text-muted-foreground leading-7">
                            From secure logins to encrypted messaging and safe
                            payment interfaces, we prioritize your security and
                            privacy at every step.
                        </p>
                    </div>
                    <div className="bg-accent/30 border-border/40 rounded-lg border p-5 backdrop-blur-lg">
                        <span className="bg-background mb-8 flex size-12 items-center justify-center rounded-full">
                            <IconMessageCircle className="text-primary size-6" />
                        </span>
                        <h3 className="mb-2 text-xl font-medium">
                            Direct Communication
                        </h3>
                        <p className="text-muted-foreground leading-7">
                            Seamless teacher-parent messaging allows for
                            real-time updates on classwork, scheduling, and
                            feedback, fostering a collaborative learning
                            environment.
                        </p>
                    </div>
                    <div className="bg-accent/30 border-border/40 rounded-lg border p-5 backdrop-blur-lg">
                        <span className="bg-background mb-8 flex size-12 items-center justify-center rounded-full">
                            <IconCalendarCheck className="text-primary size-6" />
                        </span>
                        <h3 className="mb-2 text-xl font-medium">
                            Smart Scheduling
                        </h3>
                        <p className="text-muted-foreground leading-7">
                            Manage classes efficiently with our calendar
                            integration. Receive instant notifications for class
                            updates or cancellations.
                        </p>
                    </div>
                    <div className="bg-accent/30 border-border/40 rounded-lg border p-5 backdrop-blur-lg">
                        <span className="bg-background mb-8 flex size-12 items-center justify-center rounded-full">
                            <IconBolt className="text-primary size-6" />
                        </span>
                        <h3 className="mb-2 text-xl font-medium">
                            Employability Focus
                        </h3>
                        <p className="text-muted-foreground leading-7">
                            We are committed to the bigger vision of
                            employability, providing a platform for talented
                            individuals to earn through their passion for
                            teaching.
                        </p>
                    </div>
                </div>
            ...
            <section className="pt-32 pb-16">
                <div className="container mx-auto">
                    <div className="grid gap-8 lg:grid-cols-3">
                        <h2 className="font-gloock row-span-2 text-3xl text-balance lg:text-5xl">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                We believe in open communication. Our platform
                                ensures clear visibility into tutor
                                qualifications, progress reports, and pricing,
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                We empower students to achieve their academic
                                goals and tutors to build rewarding careers.
                                Education is the key to unlocking potential, and
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                We are committed to excellence. From our
                                verified tutors to our seamless user experience,
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                We operate with honesty and strong moral
                                principles. The safety and privacy of our
                                students and parents are our top priorities.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    items = [
        {
            ...
            answer: 'Browse our verified tutor profiles, filter by subject and grade, and connect directly with the tutors that meet your requirements.',
        },
        {
            id: 'faq-2',
            question: 'Is Drona free for parents?',
            answer: 'Yes, browsing and connecting with tutors is free. You only pay for the classes you book directly with the tutor.',
        },
        {
            id: 'faq-3',
            question: 'How are tutors verified?',
            answer: 'We conduct thorough background checks and verify qualifications to ensure safety and quality for all our students.',
        },
        {
            id: 'faq-4',
            question: 'Can I cancel a class?',
            answer: "Yes, you can cancel classes through the dashboard. Cancellation policies may apply based on the tutor's terms.",
        },
        {
            id: 'faq-5',
            question: 'How do I pay?',
            answer: 'We offer a secure payment interface for hassle-free transactions directly through the platform.',
        },
    ],
}: FaqProps) => {
    return (
        <section className="py-16">
            <div className="container mx-auto max-w-3xl">
                <h1 className="font-gloock mb-4 text-3xl text-balance md:mb-11 md:text-4xl">
                    {heading}
                </h1>
            ...
            <div className="">
                <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
                    <div className="flex flex-col gap-4">
                        <h2 className="font-gloock text-3xl text-balance md:text-4xl lg:text-5xl">
                            {title}
                        </h2>
  ...
  <div className="">
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-1 items-stretch gap-x-0 gap-y-4 lg:grid-cols-3 lg:gap-4">
        ...
        <div className="relative flex items-center justify-center">
          <Image 
            width={100} 
            height={100} 
            src="/testimonials/testimonials.avif" 
            alt="Students learning" 
            className="h-72 w-full rounded-md object-cover lg:h-auto brightness-35" 
          />
        ...
        <Card className="col-span-2 flex items-center justify-center p-6">
          <div className="flex flex-col gap-4">
            <q className="text-xl font-medium font-quote italic   lg:text-3xl">
              Drona edtech is a overall reliable platform for finding a reliable, high-quality tutor for my child. The customer service is good, the tutors are genuine and also locally available. it is a recommended platform...
            </q>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card>
          <CardContent className="text-foreground/70 font-quote italic px-6 pt-6 leading-7">
            <q>
              As a tutor, Drona gives me the tools I need to organize my classes and reach more students. The platform is intuitive and professional. More power to the people behind this initiative 🙌.
            </q>
          </CardContent>
          <CardFooter>
            <div className="flex gap-4 leading-5">
              ...
              <div className="text-sm">
                <p className="font-medium">Manmeet Singh</p>
                <p className="text-muted-foreground">Tutor, Design UI/X</p>
              </div>
            </div>
          </CardFooter>
        </Card>
        <Card>
          <CardContent className="text-foreground/70 font-quote italic px-6 pt-6 leading-7">
            <q>I love the interactive learning resources and how easy it is to connect with my tutors. It makes studying much more enjoyable.</q>
          </CardContent>
          <CardFooter>
            <div className="flex gap-4 leading-5">
              <Avatar className="ring-input size-9 rounded-full ring-1">
                <AvatarImage src="/testimonials/pr_rev5SvtR7N4yQt.jpeg" alt="Priyanka Jhadodia" />
                <AvatarFallback>PJ</AvatarFallback>
              </Avatar>
              <div className="text-sm">
                <p className="font-medium">Priyanka Jhadodia</p>
        ...
        <Card>
          <CardContent className="text-foreground/70 font-quote italic px-6 pt-6 leading-7">
            <q>The verified profiles having credible teachers built our trust. We found an science tutor for our son within days. Highly recommended!</q>
          </CardContent>
          <CardFooter>
            <div className="flex gap-4 leading-5">
              <Avatar className="ring-input size-9 rounded-full ring-1">
                <AvatarImage src="/testimonials/dhv_revB4fUnSskcfC4JZ.png" alt="Dhvani Rao" />
                <AvatarFallback>DR</AvatarFallback>
              </Avatar>
              <div className="text-sm">
                <p className="font-medium">Dhvani Rao</p>
                <p className="text-muted-foreground">Parent</p>
              </div>
            </div>
          </CardFooter>
                    ...
                    <div className="max-w-screen">
                        <div className="bg-muted/40 flex flex-col items-start justify-between gap-8 rounded-lg px-6 py-10 md:flex-row lg:px-20 lg:py-16">
                            <div className="md:w-1/2">
                                <h4 className="font-gloock mb-1 text-2xl text-balance md:text-3xl">
                                    {title}
                                </h4>
                                <p className="text-muted-foreground">
                                    {description}
...
const FeatureSecondary51 = ({
    ...
    const defaultTab =
        featureSecondarys.find(tab => tab.isDefault)?.id ||
        featureSecondarys[0].id;
